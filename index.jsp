...
<body>
  <header class="site-header">
    ...
    <nav class="nav">
      <a class="btn-outline" href="register.jsp">Sign Up</a>
  ...
  <main class="hero">
    <div class="hero-content">
      ...
      <div class="cta">
        <a href="register.jsp" class="btn-primary large">Create Account (User)</a>
        <a href="login.jsp" class="btn-outline large">Login</a>
      </div>
      <p class="admin-note">
